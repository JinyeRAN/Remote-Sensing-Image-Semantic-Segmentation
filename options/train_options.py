...
class TrainOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--num-classes', type=int, default=4)
        ...
        self.parser.add_argument('--epoch-save', type=int, default=10)    #You can use this value to save model every X epochs
        ...
        self.parser.add_argument('--steps-loss', type=int, default=1)
